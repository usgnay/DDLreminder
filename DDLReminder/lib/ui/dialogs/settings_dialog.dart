...
class _SettingsDialogState extends State<_SettingsDialog> {
  ...
  void initState() {
    ...
    _textColorController = TextEditingController(
      text: _hexFromColor(_working.textColorValue),
    );
    ...
    _urgencyTintColorController = TextEditingController(
      text: _hexFromColor(_working.urgencyTintColorValue),
    );
    _backgroundOverlayColorController = TextEditingController(
      text: _hexFromColor(_working.backgroundImageOverlayColorValue),
    );
    _fontEnumerationSupported = widget.fonts.isEnumerationSupported;
    _fontsFuture = _fontEnumerationSupported
        ? widget.fonts.installedFonts()
        : Future.value(const []);
  ...
  Widget build(BuildContext context) {
    ...
    final weeklyReminderValue = _clampRecurringReminder(
      _working.weeklyReminderDays,
    ).toDouble();
    final monthlyReminderValue = _clampRecurringReminder(
      _working.monthlyReminderDays,
    ).toDouble();
              ...
              children: [
                ...
                DropdownButtonFormField<CloseAction>(
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      setState(
                        () => _working = _working.copyWith(closeAction: value),
                      );
                    }
                  },
                ),
                ...
                DropdownButtonFormField<AppLanguage>(
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      setState(
                        () => _working = _working.copyWith(language: value),
                      );
                    }
                  },
                ),
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      setState(() {
                        _working = _working.copyWith(
                          fontFamily: value,
                          customFontFamily: value == AppFontFamily.custom
                              ? _working.customFontFamily
                              : null,
                        );
                      });
                    }
                ...
                ListTile(
                  ...
                  subtitle: Slider(
                    ...
                    onChanged: (value) => setState(
                      () => _working = _working.copyWith(
                        reminderThresholdDays: value.round(),
                      ),
                    ),
                  ),
                ),
                ...
                ListTile(
                  ...
                  subtitle: Slider(
                    ...
                    onChanged: _working.showRecurringPanel
                        ? (value) => setState(
                            () => _working = _working.copyWith(
                              weeklyReminderDays: value.round(),
                            ),
                          )
                        : null,
                  ),
                ...
                ListTile(
                  ...
                  subtitle: Slider(
                    ...
                    onChanged: _working.showRecurringPanel
                        ? (value) => setState(
                            () => _working = _working.copyWith(
                              monthlyReminderDays: value.round(),
                            ),
                          )
                        : null,
                  ),
                ...
                ListTile(
                  ...
                  subtitle: Slider(
                    ...
                    onChanged: (value) => setState(
                      () => _working = _working.copyWith(surfaceOpacity: value),
                    ),
                  ),
                ),
                ListTile(
      ...
      children: [
        DropdownButtonFormField<BackgroundMode>(
          ...
          onChanged: (value) {
            if (value != null) {
              setState(
                () => _working = _working.copyWith(backgroundMode: value),
              );
            }
          },
        ),
        ...
        if (usingImage) ...[
          ...
          DropdownButtonFormField<BackgroundImageFit>(
            ...
            onChanged: (value) {
              if (value != null) {
                setState(
                  () => _working = _working.copyWith(backgroundImageFit: value),
                );
              }
            },
          ),
          ...
          _buildHexColorField(
            ...
            onValidColor: (value) => setState(
              () => _working = _working.copyWith(
                backgroundImageOverlayColorValue: value,
              ),
            ),
            language: language,
          ),
          ...
          ListTile(
            ...
            subtitle: Slider(
              ...
              divisions: 9,
              label:
                  '${(_working.backgroundImageOverlayOpacity * 100).round()}%',
              onChanged: hasImage
                  ? (value) => setState(
                      () => _working = _working.copyWith(
                        backgroundImageOverlayOpacity: value,
                      ),
                    )
                  : null,
            ),
  ...
  Future<void> _save() async {
    ...
    await widget.settings.update(
      _normalizeSettings(
        _working.copyWith(slogan: _sloganController.text.trim()),
      ),
    );
  ...
  AppSettings _normalizeSettings(AppSettings settings) {
    return settings.copyWith(
      ...
      monthlyReminderDays: _clampRecurringReminder(
      ...
      backgroundImageOverlayOpacity: settings.backgroundImageOverlayOpacity
          .clamp(.0, .45),
      backgroundImagePath: settings.backgroundImagePath?.trim().isEmpty == true
          ? null
